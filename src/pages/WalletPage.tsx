...
export function WalletPage() {
  ...
  return <div><PageHeading eyebrow="WALLET SIMULATION MODE" title="Power your" highlight="neon wallet." description="Deposit and withdraw mock funds stored only in this browser." icon={WalletCards} />
    <section className="wallet-page-grid"><NeonCard className="wallet-total"><div className="wallet-total__icon"><Zap /></div><span>AVAILABLE BALANCE</span><strong>{formatMoney(wallet.balance)}</strong><p>Bonus balance <b>{formatMoney(wallet.bonusBalance)}</b></p><div><ShieldCheck size={14} /> Local-only wallet · No payment gateway connected</div></NeonCard>
